...
@Document(collection = "detalle_factura_cliente")
public class DetalleFacturaClienteMongo {
    @Id
    private String id;
    ...
    public DetalleFacturaClienteMongo() {}

    // Constructor con parámetros
    public DetalleFacturaClienteMongo(String facturaId, String productoId, Integer cantidad, Double precio) {
